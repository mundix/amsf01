...
--
-- Host: localhost
-- Generation Time: Sep 18, 2015 at 06:41 PM
...
INSERT INTO `clients` (`id`, `type`, `rnc`, `noid`, `name`, `contact_name`, `addess`, `phone`, `cellphone`, `email`, `comments`, `created_at`, `updated_at`, `available`) VALUES
...
--
ALTER TABLE `clients`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `clients_rnc_unique` (`rnc`), ADD UNIQUE KEY `clients_noid_unique` (`noid`);
