...
@section('content')
    <div class="widget box">
        <div class="widget-header">
            <h4><i class="icon-reorder"></i>Cliente: <strong>{{ $entity->name }}</strong></h4>
        </div>
        <div class="widget-content">
            {{ Form::model($entity,['route'=>'client_update','method'=>'POST','role'=>'form','class'=>'form-horizontal row-border']) }}
